...
class draw_function:
    ...
    def __init__(self,canvas_width,canvas_height,bd):
        ...
        obj2 = self.w.create_text(self.canvas_width - self.bd, self.canvas_height + self.bd / 2, text='sent')
        obj1 = self.w.create_text(self.canvas_width - self.bd * 4,
                             self.canvas_height + self.bd / 2, text='clear')
    ...
    def paint(self,event):
        ...
        '''
        self.w.create_line(self.pre_x, self.pre_y, event.x, event.y, fill=python_green)
